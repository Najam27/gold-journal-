...
export function ManusDialog({
  ...
  return (
    ...
    >
      <DialogContent className="w-[400px] gap-0 rounded-[20px] border-border bg-card p-0 py-5 text-center text-card-foreground shadow-[0_14px_34px_var(--gj-shadow)] backdrop-blur-2xl">
        <div className="flex flex-col items-center gap-2 p-5 pt-12">
          {logo ? (
            <div className="flex h-16 w-16 items-center justify-center rounded-xl border border-border bg-popover">
              <img
                src={logo}
                alt="Dialog graphic"
