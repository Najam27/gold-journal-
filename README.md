...
2. In **Options → Private AI Provider**, paste your Google AI Studio key and choose a Gemini model (`gemini-2.5-flash` by default).
...
4. Pressing **Analyze my journal** or **AI risk coach review** sends the request straight from the browser to `https://generativelanguage.googleapis.com`, then validates the response against the shared evidence schema before rendering it.
